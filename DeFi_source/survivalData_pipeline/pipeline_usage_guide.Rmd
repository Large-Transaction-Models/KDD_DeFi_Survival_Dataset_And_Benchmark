---
title: "DMLR DeFi Survival Data Pipeline Usage Guide(qinh2):"
...
"reshape2", "pander", "readr", "dplyr", "ROSE")
...
```{r}
rdf_return = random_forest(train_data, test_data)
accuracy_rdf_dataframe = rdf_return$metrics_rdf_dataframe
accuracy_rdf = rdf_return$metrics_rdf
pander(accuracy_rdf_dataframe, caption = "Random Forest Performance")
```
...
pander(accuracy_x_dataframe, caption = "Your classification models' name")
```
...
metrics_list_XY <- list(
  ...
  list(accuracy_rdf, "Random Forest"),
